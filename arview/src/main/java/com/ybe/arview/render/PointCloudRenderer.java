...
public class PointCloudRenderer {
     ...
     *
     * @param cameraView        the camera_white view matrix for this frame, typically from {@link
     *                          com.google.ar.core.Camera#getViewMatrix(float[], int)}.
     * @param cameraPerspective the camera_white projection matrix for this frame, typically from {@link
